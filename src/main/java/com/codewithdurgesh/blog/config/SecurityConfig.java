...
@EnableWebSecurity
@EnableWebMvc
@EnableGlobalMethodSecurity(prePostEnabled = true) // To apply Rolewise security to every Controller methods
public class SecurityConfig {
	 ...
	 * permitAll() // To give public access to // urls
	 * .antMatchers(HttpMethod.GET).permitAll() // To give access publicly to GET
	 * apis without logging .anyRequest().authenticated().and().exceptionHandling()
	...
	public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
		...
		http.csrf().disable().authorizeHttpRequests().antMatchers(PUBLIC_URLS).permitAll() // To give public access to
				// urls
				.antMatchers(HttpMethod.GET).permitAll() // To give access publicly to GET apis without logging
